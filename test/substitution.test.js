...
describe("substitution", () => {
    ...
    describe("encoding a message", () => {
      ...
      it("should maintain spaces in message", () => {
        const actual = substitution("i love code", "xoyqmcgrukswaflnthdjpzibev");
        const expected = "u wlzm ylqm";
        expect(actual).to.equal(expected);
      });
    })
    describe("decoding a message", () => {
      ...
      it("should maintain spaces in message", () => {
        const actual = substitution("u wlzm ylqm", "xoyqmcgrukswaflnthdjpzibev", false);
        const expected = "i love code";
        expect(actual).to.equal(expected);
      });
    });
  });